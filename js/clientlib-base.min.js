...
(function() {
    ...
    var DELAY = 300;
    // time before fetching new results when the user is typing a search string
    var LOADING_DISPLAY_DELAY = 300;
    // minimum time during which the loading indicator is displayed
...
function gotoLocalsite(target, dtlPage) {
    // javascript:gotoLocalsite('_self');
    var userCountry = commonCode.countryCode ? commonCode.countryCode : "global";
    userCountry = userCountry.toLocaleUpperCase();
    var resultSite = "";

    // middleeast array
    var middleeastArr = ["AE", "AO", "BF", "BH", "BI", "BJ", "BW", "CF", "CG", "CI", "CM", "CV", "DJ", "DZ", "EG", "ER", "ET", "GA", "GH", "GM", "GN", "IL", "IQ", "IR", "JO", "KE", "KM", "KW", "LB", "LR", "LS", "LY", "MA", "MG", "ML", "MR", "MU", "MW", "MZ", "NA", "NE", "OM", "QA", "RW", "SA", "SC", "SD", "SL", "SN", "ST", "SY", "SZ", "TD", "TG", "TN", "TR", "TZ", "UG", "YE", "ZA", "ZM", "ZW"];

    // 2.0site array
    var tobeSiteArr = [];

    if (userCountry == "US") {
        resultSite = "https://www.hankooktire.com/us/";
    } else if (userCountry == "KR") {
        resultSite = "https://www.hankooktire.com/kr/";
    } else if (userCountry == "CA") {
        resultSite = "https://www.hankooktire.com/ca-en/";
    } else if (userCountry == "FR") {
        resultSite = "https://www.hankooktire.com/fr/";
    } else if (userCountry == "DE") {
        resultSite = "https://www.hankooktire.com/de/";
    } else if (userCountry == "IT") {
        resultSite = "https://www.hankooktire.com/it/";
    } else if (userCountry == "GB") {
        resultSite = "https://www.hankooktire.com/uk/";
    } else if (userCountry == "NL") {
        resultSite = "https://www.hankooktire.com/nl/";
    } else if (userCountry == "SE") {
        resultSite = "https://www.hankooktire.com/se/";
    } else if (userCountry == "ES") {
        resultSite = "https://www.hankooktire.com/es/";
    } else if (userCountry == "RU" || userCountry == "KZ") {
        resultSite = "https://www.hankooktire.com/ru/";
    } else if (userCountry == "TR") {
        resultSite = "https://www.hankooktire.com/tr/";
    } else if (userCountry == "PL") {
        resultSite = "https://www.hankooktire.com/pl/";
    } else if (userCountry == "HU") {
        resultSite = "https://www.hankooktire.com/hu/";
    } else if (userCountry == "CZ") {
        resultSite = "https://www.hankooktire.com/cz/";
    } else if (userCountry == "CN") {
        resultSite = "https://www.hankooktire.com/cn/";
    } else if (userCountry == "AU") {
        resultSite = "https://www.hankooktire.com/au/";
    } else if (userCountry == "JP") {
        resultSite = "https://www.hankooktire.com/jp/";
    } else if (userCountry == "ID") {
        resultSite = "https://www.hankooktire.com/id/";
    } else if (userCountry == "TH") {
        resultSite = "https://www.hankooktire.com/th/";
    } else if (userCountry == "MY") {
        resultSite = "https://www.hankooktire.com/my/";
    } else if (userCountry == "MX") {
        resultSite = "https://www.hankooktire.com/mx/";
    } else if (userCountry == "CO") {
        resultSite = "https://www.hankooktire.com/co-es/";
    } else if (userCountry == "CL") {
        resultSite = "https://www.hankooktire.com/cl/";
    } else if (userCountry == "RS") {
        resultSite = "https://www.hankooktire.com/global/en/hankook-in-your-location.html";
    } else if (userCountry == "BR") {
        resultSite = "https://m.hankooktire.com/br/";
    } else if (middleeastArr.includes(userCountry)) {
        resultSite = "https://www.hankooktire.com/mea-ar/";
    } else {
        resultSite = "https://www.hankooktire.com/global/en/home.html";
    }

    if (typeof (dtlPage) == "undefined") {
        dtlPage = "";
    }

    // hkt2.0 has detail page only
    if (tobeSiteArr.includes(userCountry)) {
        resultSite = resultSite + dtlPage;
    }

    if (target.toLocaleLowerCase() == "_self") {
        window.location.href = resultSite;
    } else {
        window.open(resultSite);
    }
}

function gotoIONPage(target) {
    // javascript:gotoLocalsite('_self');
    var userCountry = commonCode.countryCode ? commonCode.countryCode : "global";
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.resultCode == "0000") {
                ...
                userCountry = data.data.globalCountryCode.toLocaleUpperCase();
                var resultSite = "";

                if (userCountry == "US") {
                    resultSite = "https://www.hankooktire.com/us/en/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "CA") {
                    resultSite = "https://www.hankooktire.com/ca/en/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "KR") {
                    resultSite = "https://www.hankooktire.com/kr/ko/tirelist/vehicle/electric-vehicle.html";
                    //}else if(userCountry == "MEA"){

                } else if (userCountry == "DE") {
                    resultSite = "https://www.hankooktire.com/de/de/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "UK") {
                    resultSite = "https://www.hankooktire.com/uk/en/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "RO") {
                    resultSite = "https://www.hankooktire.com/ro/ro/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "IT") {
                    resultSite = "https://www.hankooktire.com/it/it/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "SE") {
                    resultSite = "https://www.hankooktire.com/se/sv/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "AU") {
                    resultSite = "https://www.hankooktire.com/au/en/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "ES") {
                    resultSite = "https://www.hankooktire.com/es/es/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "FR") {
                    resultSite = "https://www.hankooktire.com/fr/fr/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "NL") {
                    resultSite = "https://www.hankooktire.com/nl/nl/tirelist/vehicle/electric_vehicle.html";
                } else if (userCountry == "HU") {
                    resultSite = "https://www.hankooktire.com/hu/hu/tirelist/vehicle/electric_vehicle.html";
                } else if (userCountry == "CN") {
                    resultSite = "https://www.hankooktire.com/cn/zh/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "CZ") {
                    resultSite = "https://www.hankooktire.com/cz/cs/tirelist/vehicle/electric-vehicle.html";
                } else if (userCountry == "PL") {
                    resultSite = "https://www.hankooktire.com/pl/pl/tirelist/vehicle/electric_vehicle.html";
                } else if (userCountry == "TR") {
                    resultSite = "https://www.hankooktire.com/tr/tr/tirelist/vehicle/electric_vehicle.html";
                    //}else if(userCountry == "ID"){
                    //}else if(userCountry == "JP"){
                    //}else if(userCountry == "TH"){
                } else if (userCountry == "MY") {
                    resultSite = "https://www.hankooktire.com/tr/tr/tirelist/vehicle/electric-vehicle.html";
                    ...
                    resultSite = "https://www.hankooktire.com/ru/ru/tirelist/vehicle/electric-vehicle.html";
                } else {
                    const pathname = document.location.pathname;
                    if (pathname.split('/')[2] == 'en') {
...
function gotoBrandsPage(target, brands) {
    // javascript:gotoLocalsite('_self');
    var userCountry = commonCode.countryCode ? commonCode.countryCode : "global";
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data.resultCode == "0000") {
                ...
                var resultSite = "https://www.hankooktire.com/content/hankooktire/";
                var siteUrl = "";
                var isCheck = true;
                if (userCountry == "US") {
                    siteUrl = "us/en/";
                ...
                if (brands == "ventus") {
                    resultSite += siteUrl + "tirelist/brand-family/ventus.html";
                } else if (brands == "dynapro") {
                    resultSite += siteUrl + "tirelist/brand-family/dynapro.html";
                } else if (brands == "kinergy") {
                    resultSite += siteUrl + "tirelist/brand-family/kinergy.html";
                } else if (brands == "smart") {
                    resultSite += siteUrl + "tirelist/brand-family/smart.html";
                } else if (brands == "winterIcept") {
                    resultSite += siteUrl + "tirelist/brand-family/winter-i-cept.html";
                } else if (brands == "winterIpike") {
                    resultSite += siteUrl + "tirelist/brand-family/winter-i-pike.html";
                }

                if (isCheck && checkPage(resultSite)) {
                    if (target.toLocaleLowerCase() == "_self") {
                        window.location.href = resultSite.replace('/content/hankooktire/', '/');
                    } else {
                        window.open(resultSite.replace('/content/hankooktire/', '/'));
                    }
                } else {
                    ...
                    var goUrl = "";
                    if (pathname.split('/')[2] == 'en') {
                        goUrl = "https://www.hankooktire.com/global/en/home.html";
                        //"https://www.hankooktire.com/" + userCountry.toLowerCase();
                        /*if(userCountry == "US" || userCountry == "CA" || userCountry == "KR" || userCountry == "MEA" || userCountry == "DE" || userCountry == "UK" 
                            || userCountry == "RO" || userCountry == "IT" || userCountry == "SE" || userCountry == "AU" || userCountry == "ES" || userCountry == "FR"
                            || userCountry == "NL" || userCountry == "HU" || userCountry == "CN" || userCountry == "CZ" || userCountry == "PL" || userCountry == "TR"
                            || userCountry == "ID" || userCountry == "JP" || userCountry == "TH" || userCountry == "MY" || userCountry == "VN" || userCountry == "MX"
                            || userCountry == "CO" || userCountry == "BR" || userCountry == "CL" || userCountry == "RU" || userCountry == "KZ"                        
                        ) {
                            if(userCountry == "KZ"){
                                goUrl = "https://www.hankooktire.com/ru";
                            }else{
                                goUrl = "https://www.hankooktire.com/" + userCountry.toLowerCase();    
                            }
                        }else{
                            goUrl = "https://www.hankooktire.com/global/en/home.html";
                        }*/
                        ...
                        if (brands == "ventus") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/ventus.html";
                        } else if (brands == "dynapro") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/dynapro.html";
                        } else if (brands == "kinergy") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/kinergy.html";
                        } else if (brands == "smart") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/smart.html";
                        } else if (brands == "winterIcept") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/winter-i-cept.html";
                        } else if (brands == "winterIpike") {
                            goUrl = "https://www.hankooktire.com/kr/ko/tirelist/brand-family/winter-i-pike.html";
                        }
                    }
...
function setCookiePopup(d_scp_value) {
    ...
    if (getCookie(d_scp_cookiepopName) != null) {
        delCookie(d_scp_cookiepopName);
        delCookie(d_scp_cookiepopMarketingName);
    }

    if (d_scp_value != 'N') {
        setCookie(d_scp_cookiepopName, d_scp_value, 1);
        setCookie(d_scp_cookiepopMarketingName, d_scp_value, 1);
    }

    $('.cookie-pop').addClass('hidden');

    if (d_scp_value == "N") {
        sessionStorage.setItem('disAgreeCheckedEvent', true);
        //const counryNlang = window.getSitecd;
        const disagreeUrl = $('#cookieDisagreeBtn').attr('data-disagree-url');
        if (disagreeUrl) {
            if (location.port == "4502") {
                location.href = disagreeUrl;
            } else {
                location.href = disagreeUrl.replace('/content/hankooktire/', '/');
            }
        }
    }
}
...
function checkPage(siteUrl) {
    var check = false;

    siteUrl = siteUrl.replace('https://www.hankooktire.com/', '/');
    siteUrl = siteUrl.replace('https://dev-www.hankooktire.com/', '/');
...
$(document).ready(function() {
    ...
    $('input[name="cookie_all_1"]').on('click', function() {

        const checkVal = $('input[name="cookie_all_1"]:checked').val();
        const d_scp_value = checkVal == 'agree' ? 'Y' : 'N';
    ...
    $('input[name="cookie_all_2"]').on('click', function() {

        const checkVal = $('input[name="cookie_all_2"]:checked').val();
        const d_scp_value = checkVal == 'agree' ? 'Y' : 'N';

        if (getCookie(d_scp_cookiepopMarketingName) != null) {
            delCookie(d_scp_cookiepopMarketingName);
        }
        setCookie(d_scp_cookiepopMarketingName, d_scp_value, 1);
    });
